...
const Calculator = ({products, updateProduct, setInputScraps, eodScrapProducts, scrapDoughs, doughsToMix, scrapLaminatedProducts, splits, setSplits}) => {
  ...
  return (
    ...
    <div className='calc-grid-container'>
        ...
        <div className='laminated-box'>
          ...
          <br></br>
          <Splitter splits={splits} setSplits={setSplits}/>
        </div>
